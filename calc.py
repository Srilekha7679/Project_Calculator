...
root.geometry('680x486+0+0')

entryField = Entry(root, font=('arial', 20, 'bold'), bg='cyan', fg='black', bd=10, relief=SUNKEN, width=30)
...
for i in button_text_list:
    ...
    button = Button(root, width=5, height=2, bd=2, relief=SUNKEN, text=i, bg='powder blue', fg='black',
